...
set ip_repo_dir [file normalize [file join $script_dir .. .. vivado ip_repo normal_eq_accel]]
set hls_ip_dir [file normalize [file join $script_dir normal_eq_accel_prj solution1 impl ip]]
...
set export_result [catch {
    export_design -format ip_catalog \
        -description "Lightning-LM normal equation accumulator" \
        -display_name "normal_eq_accel" \
        -vendor "lightning-lm-acc" \
        -library "hls" \
        -version "1.0" \
        -ipname "normal_eq_accel"
} export_message]
