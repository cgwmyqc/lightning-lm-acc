...
entity lookup_batch_accel_control_s_axi is
generic (
...
end entity lookup_batch_accel_control_s_axi;
...
architecture behave of lookup_batch_accel_control_s_axi is
    ...
    constant ADDR_NUM_POINTS_DATA_0 : INTEGER := 16#20#;
    constant ADDR_NUM_POINTS_CTRL   : INTEGER := 16#24#;
    constant ADDR_NUM_BLOCKS_DATA_0 : INTEGER := 16#28#;
    constant ADDR_NUM_BLOCKS_CTRL   : INTEGER := 16#2c#;
