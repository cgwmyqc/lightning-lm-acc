# ==============================================================
# File generated on Sat Jun 13 15:54:15 +0800 2026
...
## IP Info
set Vendor      "lightning-lm-acc"
set Library     "hls"
set IPName      "lookup_batch_accel"
set Version     "1.0"
set DisplayName "lookup_batch_accel"
set Revision    "1"
set Description "Lightning-LM surfel lookup batch accelerator"
set Device      "zynq"
set AutoFamily  ""
set Taxonomy    "/VIVADO_HLS_IP"
set has_xpm_memory "0"
set sdx_kernel_name "lookup_batch_accel"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. sdaccel]
set xo_hls_files_dir ""
set hdl_module_list {lookup_batch_accebkb
lookup_batch_accecud
lookup_batch_accedEe
lookup_batch_acceeOg
lookup_batch_accefYi
lookup_batch_acceg8j
lookup_batch_accel_control_s_axi
lookup_batch_accel_gmem_m_axi
p_anonymous_namespace_2
p_anonymous_namespace_1
p_anonymous_namespace
lookup_batch_accel
}
set kernel_xo ""

## Variables
set Top "lookup_batch_accel"
set TopNoPrefix "lookup_batch_accel"
